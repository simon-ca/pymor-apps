...
if HAVE_ALL:
    ...
    from domaintransformation.grids.constructions import flatten_grid
    ...
    class GLPatchWidget(QGLWidget):
        ...
        def __init__(self, parent, grid, mu, vmin=None, vmax=None, bounding_box=([0, 0], [1, 1]), codim=2):
            ...
            subentities, coordinates, entity_map = flatten_grid(grid, mu)
